...
const RecommendTagCarousel = () => {
    return (
      ...
      <div class="container-fluid">
        <h2 class="my-5">Người dùng thường tìm kiếm</h2>
        <a href="#" class="btn btn-warning me-2 mb-2">Máy điện</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Máy làm kem</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Tủ lạnh</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Điều hòa</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Fushimavina</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Tin tức sản phẩm mới</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Quạt hơi nước</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Sản phẩm cũ giá rẻ</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Máy giặt</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Máy lọc nước</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Máy chính hãng</a>
      </div>
    </section>
           <section class="py-5">
      <div class="container-fluid">
