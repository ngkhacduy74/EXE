...
const RecommendTagCarousel = () => {
    ...
    const handleTagClick = (tagText) => {
        // Lưu search term vào localStorage để Header có thể đọc
        localStorage.setItem('searchFromTag', tagText);
        
        // Navigate đến ProductBrowser với search parameter
        navigate(`/product-browser?search=${encodeURIComponent(tagText)}`);
        
        // Trigger custom event để Header có thể cập nhật search box
        window.dispatchEvent(new CustomEvent('tagSearch', { 
            detail: { searchTerm: tagText } 
        }));
    };
    ...
    return (
      ...
      <div className="container-fluid">
        ...
        <button 
            ...
            onClick={() => handleTagClick("máy làm kem")}
        >
            Máy điện
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("fushima")}
        >
            Máy làm kem
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("tủ lạnh")}
        >
            Tủ lạnh
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("máy làm đá")}
        >
            Điều hòa
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("Fushimavina")}
        >
            Fushimavina
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("ababa")}
        >
            Tin tức sản phẩm mới
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("quạt")}
        >
            Quạt hơi nước
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("sản phẩm cũ")}
        >
            Sản phẩm cũ giá rẻ
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("sản phẩm mới ra")}
        >
            Máy giặt
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("Máy lạnh")}
        >
            Máy lọc nước
        </button>
        <button 
            className="btn btn-warning me-2 mb-2" 
            onClick={() => handleTagClick("chính hãng")}
        >
            Máy chính hãng
        </button>
      </div>
              ...
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    ...
                    <p className="card-text">Dễ dàng tìm kiếm sản phẩm</p>
                  </div>
                </div>
              </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    ...
                    <p className="card-text">Xác thực email mỗi lần đăng nhập</p>
                  </div>
                </div>
              </div>
              </div>
            ...
            <div className="card mb-3 border-0">
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    <h5>Tích hợp</h5>
                    <p className="card-text">Kiếm soát chất lượng qua từng sản phẩm</p>
                  </div>
                </div>
              </div>
              </div>
            ...
            <div className="card mb-3 border-0">
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    <h5>Tích hợp AI</h5>
                    <p className="card-text">AI giúp bạn trả lời các câu hỏi về sản phẩm</p>
                  </div>
                </div>
              </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    ...
                    <p className="card-text">Hỗ trợ so sánh các sản phẩm</p>
                  </div>
                </div>
              </div>
              </div>
